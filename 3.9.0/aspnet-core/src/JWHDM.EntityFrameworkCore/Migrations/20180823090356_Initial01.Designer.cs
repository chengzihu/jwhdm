...
namespace JWHDM.Migrations
{
    ...
    [Migration("20180823090356_Initial01")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JWHDM.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("JWHDM.Challenges.Challenge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("JWHDM.UserMembers.UserMember", b =>
                {
                    ...
                    b.Property<string>("AttendanceAddress")
                        .HasMaxLength(200);
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("JWHDM.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("JWHDM.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("JWHDM.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("JWHDM.Authorization.Users.User", "DeleterUser")
                        .WithMany()
            ...
            modelBuilder.Entity("JWHDM.LessonMinds.LessonMind", b =>
                {
                    b.HasOne("JWHDM.UserMembers.UserMember")
                        .WithMany("LessonMinds")
            ...
            modelBuilder.Entity("JWHDM.UserMembers.UserMember", b =>
                {
                    b.HasOne("JWHDM.LessonMinds.LessonMind")
